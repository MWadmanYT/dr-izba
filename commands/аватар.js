exports.run = (client, message) => {
    ...
    const embedAvatar = new Discord.RichEmbed().setImage(message.author.avatarURL).setColor("ffda8b");
    if(!otherAvatar){
    ...
    console.log('Команда "аватар" использована пользователем ' + message.author.username + '. Результат - успешно');
}